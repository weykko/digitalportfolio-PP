...
class TestGroupUsersView(AdminTemplateTestUtils, WagtailTestUtils, TestCase):
    ...
    def test_simple(self):
        ...
        self.assertTemplateUsed(response, "wagtailusers/users/home.html")
...
class TestGroupIndexView(AdminTemplateTestUtils, WagtailTestUtils, TestCase):
    ...
    def test_simple(self):
        response = self.get()
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "wagtailusers/groups/home.html")
        self.assertTemplateUsed(response, "wagtailadmin/generic/home.html")
